...
export interface DemoState { version:2; outfitAppearance?:{productId:string;key:string}; userId:string; outfitId:string; foodQuantity:Record<string,number>; lampOn:boolean; featuredBeautyId:string|null; avatarRoom:string; avatarId:'m01'|'m02'|'f01'|'f02'; }
...
export function outfitArtKey(home:DemoHome,state:DemoState):AvatarOutfit;
