...
export class InteractionController {
 ...
 dispatch(e){
  ...
  if(e.type==='ARRIVED'&&this.owner==='movement'&&e.epoch===this.epoch&&e.id===this.targetObject&&e.pathEmpty&&isWalkable(e.position.x,e.position.y)){
   ...
   if(id==='lamp'){this.owner='modal:'+id;this.phase='idle';this.emit('modal',{id});}
 ...
 completeStep(){const id=this.objectId;
  if(this.phase==='exiting'){if(id!=='pantry')this.settle(id);const intent=this.pendingIntent;this.pendingIntent=null;this.owner='none';this.phase='idle';this.step='idle';this.action=null;this.standingAnchor=null;this.emit('exit',{id,intent});if(intent)this.emit('intent',{intent});return;}
  if(this.step==='align'){
